    ...
    return Theme(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: Colors.grey.withOpacity(0.95), fontWeight: FontWeight.w600),
    ...
    return ButtonTheme(
      ...
      child: FlatButton(
        ...
        child: Padding(
          ...
          child: Text(this.text, style: TextStyle(fontSize: 17.0, fontWeight: FontWeight.bold)),
        ),
      ),
    );
  }
